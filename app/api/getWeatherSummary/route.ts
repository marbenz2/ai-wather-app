...
export async function POST(request: Request) {
  ...
  const respnse = await openai.createChatCompletion({
    model: "gpt-3.5-turbo",
    temperature: 0.8,
    n: 1,
    stream: false,
